...
voce_t* leggiVociDaFile2(char *nomeFile, int *nr);
...
int main(int argc, char** argv) {
  ...
  char *scelte[] = {
    ...
    "        su  file (con scelta tipo ord.)",
    "Ricerca per codice (parziale)",
    "        per stazione di partenza",
	"Carica  nuovi dati da file"
  };
  ...
  int nr;    // numero registrazioni trovate nel file di log

  voce_t *elenco = leggiVociDaFile2(FILE_IN, &nr);
  voce_t **elencoRifData = (voce_t **) malloc(nr * sizeof(voce_t *));
  voce_t **elencoRifCod = (voce_t **) malloc(nr * sizeof(voce_t *));
  voce_t **elencoRifPart = (voce_t **) malloc(nr * sizeof(voce_t *));
  voce_t **elencoRifArr = (voce_t **) malloc(nr * sizeof(voce_t *));

for (int i = 0; i < nr; i++){ // caricamento vettori di puntatori a elementi di "elenco"
  ...
  do {
    ...
    case 9: {
        printf("Inserire nome file (invio per annullare)\n");
        scanf("%s",nomeFile);
        if (strlen(nomeFile) > 0){
        	  free(elenco);        free(elencoRifData); free(elencoRifCod);
        	  free(elencoRifPart); free(elencoRifArr);
        	  elenco = leggiVociDaFile2(nomeFile, &nr);
        	  elencoRifData = (voce_t **) malloc(nr * sizeof(voce_t *));
        	  elencoRifCod = (voce_t **) malloc(nr * sizeof(voce_t *));
        	  elencoRifPart = (voce_t **) malloc(nr * sizeof(voce_t *));
        	  elencoRifArr = (voce_t **) malloc(nr * sizeof(voce_t *));
...
voce_t* leggiVociDaFile2(char *nomeFile, int *nr){
	  ...
	  *nr = n;
	  ...
	  voce_t *el = (voce_t  *) malloc(n * sizeof(voce_t));
